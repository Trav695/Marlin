...
#define INPUT_SHAPING_Y //RTB
  ...
  #define SHAPING_MENU  //RTB           // Add a menu to the LCD to set shaping parameters.
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD   //RTB    // Add a Probe Z Offset calibration option to the LCD menu
...
#define ADVANCED_PAUSE_FEATURE  //RTB
  ...
  #define PARK_HEAD_ON_PAUSE //RTB                   // Park the nozzle during pause and filament change.
